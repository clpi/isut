...
class Ui_renderOp(object):
    def setupUi(self, renderOp):
        ...
        self.groupBox = QGroupBox(self.renderTabVideoTab)
        ...
        self.groupBox_2 = QGroupBox(self.renderTabVideoTab)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 438, 436))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 438, 436))

...
class Ui_sectionOp(object):
    ...
    def retranslateUi(self, sectionOp):
        ...
        ___qlistwidgetitem.setText(QCoreApplication.translate("sectionOp", u"Step has TP, next step without TP", None));
        ___qlistwidgetitem1 = self.sectionRulesListWidget.item(1)
        ___qlistwidgetitem1.setText(QCoreApplication.translate("sectionOp", u"Step has TP, next step with TP", None));
        ___qlistwidgetitem2 = self.sectionRulesListWidget.item(2)
        ___qlistwidgetitem2.setText(QCoreApplication.translate("sectionOp", u"Step has TP, previous step without TP", None));
        ___qlistwidgetitem3 = self.sectionRulesListWidget.item(3)
        ___qlistwidgetitem3.setText(QCoreApplication.translate("sectionOp", u"Step has TP, previous step with TP", None));
        ___qlistwidgetitem4 = self.sectionRulesListWidget.item(4)
        ___qlistwidgetitem4.setText(QCoreApplication.translate("sectionOp", u"Step has fade-in", None));
        ___qlistwidgetitem5 = self.sectionRulesListWidget.item(5)
        ___qlistwidgetitem5.setText(QCoreApplication.translate("sectionOp", u"Step has jump box", None));
        ___qlistwidgetitem6 = self.sectionRulesListWidget.item(6)
        ___qlistwidgetitem6.setText(QCoreApplication.translate("sectionOp", u"Step TP contains text pattern...", None));
        self.sectionRulesListWidget.setSortingEnabled(__sortingEnabled)

        self.label_10.setText(QCoreApplication.translate("sectionOp", u"Insert new section on...", None))
        self.sectionCoverageLabel.setText(QCoreApplication.translate("sectionOp", u"Covers 0 steps in selected sections/steps", None))
        self.label_11.setText(QCoreApplication.translate("sectionOp", u"May not match number of audio soundbites (audio not imported)", None))
        pass
    # retranslateUi

...
class Ui_audioOp(object):
    ...
    def retranslateUi(self, audioOp):
        self.comboBox.setItemText(0, QCoreApplication.translate("audioOp", u"Mixed section and step audio", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("audioOp", u"Section audio only", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("audioOp", u"Step audio only", None))

        self.label_8.setText(QCoreApplication.translate("audioOp", u"Audio attachment behavior", None))
        pass
    # retranslateUi

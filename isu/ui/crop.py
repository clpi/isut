...
class Ui_cropOp(object):
    ...
    def retranslateUi(self, cropOp):
        self.label_14.setText(QCoreApplication.translate("cropOp", u"Crop start coordinates", None))
        self.label_30.setText(QCoreApplication.translate("cropOp", u"X", None))
        self.label_31.setText(QCoreApplication.translate("cropOp", u"Y", None))
        self.label_15.setText(QCoreApplication.translate("cropOp", u"Crop dimensions", None))
        self.label_35.setText(QCoreApplication.translate("cropOp", u"Width", None))
        self.label_36.setText(QCoreApplication.translate("cropOp", u"Height", None))
        pass
    # retranslateUi

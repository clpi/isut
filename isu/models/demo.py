...
class DemoModel(QAbstractListModel):
    """
    The table widget model representing XML .demo DemoMate data.
...
from PySide6.QtWidgets import (QFileDialog, QHeaderView, QMainWindow, QMessageBox, QStyle, QTreeWidget, QTreeWidgetItem, QWidget)
from PySide6.QtXml import QDomDocument

class DemoTree(QTreeWidget):
    def __init__(self, parent=None):
